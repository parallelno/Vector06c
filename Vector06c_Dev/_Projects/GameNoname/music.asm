...
song_08: .byte $49,$0e,$0d,$0c,$0b,$0a,$09,$38,$e8,$1f,$c4,$41,$f7,$d0,$90,$40,$55,$6e,$0f,$e6,$bc,$0a,$fe,$fa,$e8,$0b,$17,$81,$dc,$b9,$0b,$d0,$7c,$a0,$39,$70,$5e,$40,$11,$16,$3b,$0d,$0d,$ec,$84,$40,$f9,$d1,$40,$3d,$d0,$79,$70,$5e,$40,$11,$42,$85,$0d,$b8,$0d,$d0,$15,$14,$30,$00,$08
song_09: .byte $85,$00,$55,$61,$91,$0f,$0e,$0d,$0c,$0b,$f5,$dc,$1f,$e8,$5e,$40,$01,$14,$21,$f1,$0a,$0a,$09,$08,$08,$dc,$1e,$40,$14,$17,$d6,$f8,$fb,$0f,$cf,$cc,$97,$e8,$df,$f4,$d0,$5e,$94,$07,$d1,$70,$e4,$28,$1b,$0b,$85,$fe,$32,$80,$45,$5b,$0a,$81,$fe,$32,$80,$01,$0f,$fe,$44,$c8,$80,$51,$6e,$0a,$fe,$52,$fa,$0f,$98,$0a,$e6,$e9,$09,$08,$07,$01,$e7,$c4,$c3,$b8,$95,$e8,$7c,$40,$10,$f9,$46,$7e,$06,$05,$04,$03,$02,$01,$00,$ff,$dc,$07,$d1,$a0,$f5,$e0,$f9,$ff,$60,$79,$40,$55,$cd,$08,$1e,$f4,$7d,$b8,$7d,$e8,$57,$d5,$40,$73,$20,$47,$81,$dc,$f4,$a0,$7d,$e0,$7e,$7b,$60,$5f,$40,$04,$3d,$fe,$fb,$7c,$08,$80,$dc,$1e,$e8,$5e,$40,$05,$57,$00,$00,$80
song_10: .byte $49,$0e,$0d,$0c,$0b,$0a,$09,$38,$e8,$1f,$c4,$41,$f7,$d0,$90,$40,$55,$6e,$0f,$e6,$bc,$0a,$fe,$fa,$e8,$0b,$17,$81,$dc,$b9,$0b,$d0,$7c,$a0,$39,$70,$5e,$40,$44,$45,$b9,$1f,$fe,$39,$70,$38,$d0,$43,$95,$70,$e0,$40,$41,$55,$c0,$00,$20
song_11: .byte $90,$00,$01,$16,$85,$47,$55,$a1,$59,$55,$a1,$50,$55,$a1,$47,$05,$a1,$00,$68,$47,$55,$68,$59,$41,$68,$00,$5a,$50,$15,$5a,$47,$10,$5a,$00,$16,$85,$47,$56,$84,$59,$16,$85,$00,$a1,$50,$55,$a1,$47,$55,$68,$59,$55,$68,$50,$55,$68,$47,$55,$5a,$59,$15,$5a,$50,$15,$5a,$47,$15,$56,$85,$59,$56,$84,$50,$17,$00,$00,$80
song_12: .byte $94,$00,$55,$55,$c0,$00,$20
song_13: .byte $90,$ff,$01,$16,$f4,$08,$d0,$41,$2c,$01,$95,$80,$55,$38,$d0,$01,$55,$c0,$00,$20

;
; runtime data (careful with relative = directives)
;
...
stacks          
stack_00        = stacks
stack_01        = stack_00 + task_stack_size
stack_02        = stack_01 + task_stack_size
stack_03        = stack_02 + task_stack_size
stack_04        = stack_03 + task_stack_size
stack_05        = stack_04 + task_stack_size
stack_06        = stack_05 + task_stack_size
stack_07        = stack_06 + task_stack_size
stack_08        = stack_07 + task_stack_size
stack_09        = stack_08 + task_stack_size
stack_10        = stack_09 + task_stack_size
stack_11        = stack_10 + task_stack_size
stack_12        = stack_11 + task_stack_size
stack_13        = stack_12 + task_stack_size
stack_14        = stack_13 + task_stack_size
stack_15        = stack_14 + task_stack_size
stacks_end      = stack_15 + task_stack_size

; array of task sp: context[i] = task's stack pointer
context         = stacks_end
context_end     = context + 2 * n_tasks

context_ptr:    = context_end
bss_end         = context_ptr + 2


; buffers for unpacking the streams, must be aligned to 256 byte boundary

buffer00        =     0xff00 & bss_end + 256        
buffer01        =     0xff00 & bss_end + 256 * 2        
buffer02        =     0xff00 & bss_end + 256 * 3
buffer03        =     0xff00 & bss_end + 256 * 4        
buffer04        =     0xff00 & bss_end + 256 * 5
buffer05        =     0xff00 & bss_end + 256 * 6        
buffer06        =     0xff00 & bss_end + 256 * 7
buffer07        =     0xff00 & bss_end + 256 * 8        
buffer08        =     0xff00 & bss_end + 256 * 9
buffer09        =     0xff00 & bss_end + 256 * 10        
buffer10        =     0xff00 & bss_end + 256 * 11
buffer11        =     0xff00 & bss_end + 256 * 12       
buffer12        =     0xff00 & bss_end + 256 * 13
buffer13        =     0xff00 & bss_end + 256 * 14       
