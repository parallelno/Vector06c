RamDiskInit:
			...
			lxi d, __splitB0_addr0 + SCR_BUFF1_ADDR
			lxi h, __splitB0_addr0
			lxi b, __splitB0_addr0 / 2
			...
			lxi h, SCR_BUFF1_ADDR - __splitB0_addr0
			call __SpriteDupPreshift
			RAM_DISK_OFF()
			; copy sprites chunk1 to their designated space in the ram-disk
			lxi d, __splitB0_addr1 - __splitB0_addr0 + SCR_BUFF1_ADDR
			lxi h, __splitB0_addr1
			lxi b, (__splitB0_addr1 - __splitB0_addr0) / 2
			mvi a, RAM_DISK_S0 | RAM_DISK_M2 | RAM_DISK_M_8F
			call CopyToRamDisk
