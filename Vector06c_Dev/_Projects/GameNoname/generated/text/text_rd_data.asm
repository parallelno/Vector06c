...
__text_knocked_his_home_door:
			TEXT("Oh, that was super freshy outside for a walk", _LINE_BREAK_)
			TEXT("today! Next time, my buddy Natias has to", _LINE_BREAK_)
...
__text_storytelling_farm_storage:
			TEXT("Who's that dude on my road?", _LINE_BREAK_)
