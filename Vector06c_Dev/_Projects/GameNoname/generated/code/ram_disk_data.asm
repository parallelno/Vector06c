...
; bank0 addr0    [ 1054 free]
; description: 
; hero_r_sprites: 14466
; skeleton_sprites: 10140
; scythe_sprites: 1626
; hero_attack01_sprites: 5226

; bank0 addr8000 [32552 free]
; description: 
; torch_sprites: 216

; bank1 addr0    [ 5554 free]
; description: 
; knight_sprites: 16398
; burner_sprites: 9600
; bomb_slow_sprites: 960

; bank1 addr8000 [    0 free]
; description: $8000-$9FFF tiledata buffer (collision, copyToScr, etc), $A000-$FFFF back buffer2 (to restore a background in the back buffer)

; bank2 addr0    [10162 free]
; description: 
; hero_l_sprites: 14466
; vampire_sprites: 7884

; bank2 addr8000 [19856 free]
; description: Music player and songs
; song01: 12542
; gigachad_player_rd: 370

; bank3 addr0    [26212 free]
; description: 
; level01: 6300

; bank3 addr8000 [ 6136 free]
; description: $8000-$9FFF code library. $A000-$FFFF back buffer
; sprite_rd: 173
; draw_sprite_rd: 544
; utils_rd: 87
; sprite_preshift_rd: 1538
