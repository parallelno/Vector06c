...
; bank0 addr8000 [ 9220 free] description: 
;                             level00_data [3820], backs_sprites [620], decals_sprites [4446], vfx4_sprites [4686], level01_data [798], tiled_images_gfx [8178], tiled_images_data [1000], 
...
; bank3 addr8000 [  214 free] description: $8000-$9FFF code library. $A000-$FFFF backbuffer (to avoid sprite flickering)  
;                             global_consts_rd [0], sprite_rd [172], draw_sprite_rd [340], draw_sprite_hit_rd [318], draw_sprite_invis_rd [26], utils_rd [88], sprite_preshift_rd [1542], text_rd_data [4882], text_ex_rd [384], game_score_data_rd [226], 
; [142534 total/37469 compressed][65597 total free]
