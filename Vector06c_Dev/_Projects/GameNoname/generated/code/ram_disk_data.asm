...
; bank0 addr8000 [13800 free] description: 
;                             level00_data [544], backs_sprites [620], decals_sprites [3640], vfx4_sprites [4686], level01_data [798], tiled_images_gfx [7702], tiled_images_data [978], 
...
; bank3 addr8000 [ 3645 free] description: $8000-$9FFF code library. $A000-$FFFF backbuffer (to avoid sprite flickering) 
;                             global_consts_rd [0], sprite_rd [172], draw_sprite_rd [340], draw_sprite_hit_rd [318], draw_sprite_invis_rd [26], utils_rd [87], sprite_preshift_rd [1541], text_ex_rd [389], text_rd [1558], game_score_data_rd [116], 
; [129413 total/30179 compressed][78718 total free]
