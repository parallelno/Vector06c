...
; bank0 addr8000 [11990 free] description: 
;                             level00_data [1720], backs_sprites [620], decals_sprites [4274], vfx4_sprites [4686], level01_data [798], tiled_images_gfx [7702], tiled_images_data [978], 
