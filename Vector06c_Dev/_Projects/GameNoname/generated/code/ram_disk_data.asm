...
; bank0 addr8000 [12232 free] description: 
;                             level00_data [1477], backs_sprites [620], decals_sprites [4274], vfx4_sprites [4686], level01_data [798], tiled_images_gfx [7702], tiled_images_data [978], 
...
; bank3 addr8000 [ 2571 free] description: $8000-$9FFF code library. $A000-$FFFF backbuffer (to avoid sprite flickering) 
;                             global_consts_rd [0], sprite_rd [172], draw_sprite_rd [340], draw_sprite_hit_rd [318], draw_sprite_invis_rd [26], utils_rd [87], sprite_preshift_rd [1541], text_ex_rd [389], text_rd [2542], game_score_data_rd [206], 
; [132406 total/32068 compressed][75724 total free]
