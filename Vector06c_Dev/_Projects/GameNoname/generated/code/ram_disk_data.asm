...
; bank0 addr8000 [ 9232 free] description: 
;                             level00_data [3808], backs_sprites [620], decals_sprites [4446], vfx4_sprites [4686], level01_data [798], tiled_images_gfx [8178], tiled_images_data [1000], 
...
; bank3 addr8000 [  898 free] description: $8000-$9FFF code library. $A000-$FFFF backbuffer (to avoid sprite flickering)  
;                             global_consts_rd [0], sprite_rd [172], draw_sprite_rd [340], draw_sprite_hit_rd [318], draw_sprite_invis_rd [26], utils_rd [88], sprite_preshift_rd [1542], text_ex_rd [390], text_rd [4192], game_score_data_rd [226], 
; [139338 total/36697 compressed][68793 total free]
