...
; bank0 addr8000 [ 9236 free] description: 
;                             level00_data [3804], backs_sprites [620], decals_sprites [4446], vfx4_sprites [4686], level01_data [798], tiled_images_gfx [8178], tiled_images_data [1000], 
...
; bank3 addr8000 [  690 free] description: $8000-$9FFF code library. $A000-$FFFF backbuffer (to avoid sprite flickering)  
;                             global_consts_rd [0], sprite_rd [172], draw_sprite_rd [340], draw_sprite_hit_rd [318], draw_sprite_invis_rd [26], utils_rd [88], sprite_preshift_rd [1542], text_ex_rd [390], text_rd [4400], game_score_data_rd [226], 
; [139542 total/36814 compressed][68589 total free]
