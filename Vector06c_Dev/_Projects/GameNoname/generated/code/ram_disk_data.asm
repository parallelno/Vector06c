...
; bank0 addr0    [ 2794 free] description: 
;                             hero_r_sprites [13818], skeleton_sprites [10140], scythe_sprites [1626], bomb_sprites [960], snowflake_sprites [1332], font_rus_gfx [1842], 
; bank0 addr8000 [ 9234 free] description: 
;                             level00_data [3806], backs_sprites [620], decals_sprites [4446], vfx4_sprites [4686], level01_data [798], tiled_images_gfx [8178], tiled_images_data [1000], 
...
; bank3 addr8000 [ 4886 free] description: $8000-$9FFF code library. $A000-$FFFF backbuffer (to avoid sprite flickering)  
;                             global_consts_rd [0], sprite_rd [172], draw_sprite_rd [340], draw_sprite_hit_rd [318], draw_sprite_invis_rd [26], utils_rd [88], sprite_preshift_rd [1542], text_rd_data [210], text_ex_rd [384], game_score_data_rd [226], 
; [135558 total/34450 compressed][72573 total free]
