...
; bank0 addr0    [ 3514 free] description: 
;                             hero_r_sprites [13818], skeleton_sprites [10140], scythe_sprites [1626], bomb_sprites [960], snowflake_sprites [1332], font_rus_gfx [1122], 
...
;                             global_consts_rd [0], sprite_rd [172], draw_sprite_rd [340], draw_sprite_hit_rd [318], draw_sprite_invis_rd [26], utils_rd [88], sprite_preshift_rd [1542], text_rd_data [4356], text_ex_rd [320], game_score_data_rd [226], 
; [138920 total/36555 compressed][69211 total free]
