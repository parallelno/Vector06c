...
bomb_slow_preshifted_sprites:
			.byte 4
bomb_slow_anims:
			.word bomb_slow_run, bomb_slow_dmg, 0, 
bomb_slow_run:
...
bomb_slow_dmg:
			.byte 9, 0 ; offset to the next frame
			.word __bomb_slow_dmg0_0, __bomb_slow_dmg0_1, __bomb_slow_dmg0_2, __bomb_slow_dmg0_3, 
			.byte 245, $ff ; offset to the first frame
			.word __bomb_slow_dmg1_0, __bomb_slow_dmg1_1, __bomb_slow_dmg1_2, __bomb_slow_dmg1_3, 
