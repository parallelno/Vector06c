...
__bomb_sprites:
			.byte 1,1  ; safety pair of bytes to support a stack renderer, and also (mask_flag, preshifting is done)
__bomb_run0_0:
			...
			.byte -1, 1 ; safety pair of bytes to support a stack renderer and also (copy_from_buff_offset, mask_flag)
__bomb_run0_1:
			.byte 4, 0; offset_y, offset_x
			.byte 6, 0; height, width
			.byte 255,0,255,0,255,0,255,0,255,0,255,0,255,0,255,0,255,0,255,0,255,0,255,0,255,0,255,0,255,0,255,0,255,0,255,0,

			.byte 0, 1 ; safety pair of bytes to support a stack renderer and also (copy_from_buff_offset, mask_flag)
__bomb_run0_2:
			.byte 4, 0; offset_y, offset_x
