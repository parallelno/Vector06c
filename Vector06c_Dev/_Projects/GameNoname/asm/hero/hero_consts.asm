...
HERO_STATUS_INVINCIBLE		= 2 | ACTOR_STATUS_BIT_BLINK
HERO_STATUS_IMPACTED		= 3 | ACTOR_STATUS_BIT_BLINK
...
HERO_STATUS_DEATH_FALL_ANIM		= 4 | ACTOR_STATUS_BIT_NON_GAMEPLAY | ACTOR_STATUS_BIT_INVIS
