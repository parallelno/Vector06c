...
;===================================================================================
__text_no_health:
			TEXT("O, net! ..dolzhen spasti.. druga - skazal", LINE_BREAK)
			TEXT("geroj i upal v glubokuyu, ledyanuyu t'mu.", LINE_BREAK)
			TEXT("Pokazalos chto vsya nadezhda utrachena. No", LINE_BREAK)
			TEXT("potom chudom, ego glaza otkrylis.")

__text_knocked_his_home_door:
			TEXT("Ogo, eto bilo klasnay i osvejausaya progulka", LINE_BREAK)
			TEXT("V sleduyushii raz moi drug Natias doljen poiti", LINE_BREAK)
			TEXT("so mnoi, bez voprosov. Zavtra ya obyazatelno", LINE_BREAK)
			TEXT("zaskochu k nemu, eto bez!")
